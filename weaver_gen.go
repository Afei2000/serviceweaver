...
func init() {
	...
	codegen.Register(codegen.Registration{
		...
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return reverser_local_stub{impl: impl.(Reverser), tracer: tracer, activeMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "hello/Reverser", Method: "Active", Remote: false}), initMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "hello/Reverser", Method: "Init", Remote: false}), reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "hello/Reverser", Method: "Reverse", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, activeMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "hello/Reverser", Method: "Active", Remote: true}), initMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "hello/Reverser", Method: "Init", Remote: true}), reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "hello/Reverser", Method: "Reverse", Remote: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
...
type reverser_local_stub struct {
	impl           Reverser
	tracer         trace.Tracer
	activeMetrics  *codegen.MethodMetrics
...
func (s reverser_local_stub) Active(ctx context.Context, a0 string) (r0 string, err error) {
	// Update metrics.
	begin := s.activeMetrics.Begin()
	defer func() { s.activeMetrics.End(begin, err != nil, 0, 0) }()
	span := trace.SpanFromContext(ctx)
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "main.Reverser.Active", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
	...
	return s.impl.Active(ctx, a0)
}

func (s reverser_local_stub) Init(ctx context.Context) (err error) {
	// Update metrics.
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "main.Reverser.Init", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
				span.RecordError(err)
				span.SetStatus(codes.Error, err.Error())
...
func (s reverser_client_stub) Active(ctx context.Context, a0 string) (r0 string, err error) {
	// Update metrics.
	var requestBytes, replyBytes int
	begin := s.activeMetrics.Begin()
	defer func() { s.activeMetrics.End(begin, err != nil, requestBytes, replyBytes) }()

	span := trace.SpanFromContext(ctx)
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "main.Reverser.Active", trace.WithSpanKind(trace.SpanKindClient))
	}
...
func (s reverser_client_stub) Init(ctx context.Context) (err error) {
	// Update metrics.
	var requestBytes, replyBytes int
	begin := s.initMetrics.Begin()
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "main.Reverser.Init", trace.WithSpanKind(trace.SpanKindClient))
	}
...
func (s reverser_server_stub) active(ctx context.Context, args []byte) (res []byte, err error) {
	// Catch and return any panics detected during encoding/decoding/rpc.
	defer func() {
		if err == nil {
			err = codegen.CatchPanics(recover())
	...
	r0, appErr := s.impl.Active(ctx, a0)
...
func (s reverser_server_stub) init(ctx context.Context, args []byte) (res []byte, err error) {
	// Catch and return any panics detected during encoding/decoding/rpc.
	defer func() {
		if err == nil {
			err = codegen.CatchPanics(recover())
...
func (s reverser_reflect_stub) Active(ctx context.Context, a0 string) (r0 string, err error) {
	err = s.caller("Active", ctx, []any{a0}, []any{&r0})
	return
}

func (s reverser_reflect_stub) Init(ctx context.Context) (err error) {
